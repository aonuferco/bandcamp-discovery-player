...
| `1.1.0` | First minor since `1.0.1`. **52 merged PRs** (#19#72, skipping unpublished #66 and #68): genre backgrounds, mobile UI, security hardening, error handling, TypeScript strictness, frontend modularity, performance, WCAG 2.1 AA, CI, persistent preferences, custom transport + volume, fuzzy genre search, and playback error recovery |
